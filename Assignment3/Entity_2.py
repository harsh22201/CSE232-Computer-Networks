...
server_packet_address = ('localhost', 3403)  # Entity_2 address
server_ack_address = ('localhost', 3404)  # Entity_2 address
client_packet_address = ('localhost', 3401)  # Entity_1 address
client_ack_address = ('localhost', 3402)  # Entity_1 address
